...
require_once THIRD_PARTY . '/php-jwt/JWT.php';
require_once THIRD_PARTY . '/php-jwt/BeforeValidException.php';
require_once THIRD_PARTY . '/php-jwt/ExpiredException.php';
require_once THIRD_PARTY . '/php-jwt/SignatureInvalidException.php';
