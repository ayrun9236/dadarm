...
class Service_coupon extends Service_common
{
	...
	public function create($params)
	{
		...
		$insert_data = array(
			...
			'is_publish_store_all' => $params['is_publish_store_all'] === 'true' ? 1 : 0,
			'use_store' => $params['use_store'],
			'publish_store' => $params['publish_store'],
		);
		...
		if($params['is_publish_store_all'] === 'true'){
			$insert_data['publish_store'] = '';
		}
