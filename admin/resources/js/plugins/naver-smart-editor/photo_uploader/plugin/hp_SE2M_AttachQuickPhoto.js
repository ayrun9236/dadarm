...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		var addParams = '';
		if(typeof(parent.parent.photolink) == 'function'){
			addParams = parent.parent.photolink();
		}
		//var sPopupUrl = "./photo_uploader/popup/photo_uploader.html";
		var sPopupUrl = "./photo_uploader/popup/index.html"+(addParams ? '?'+addParams: '');
		return sPopupUrl;
	},

	photoUrlParams : function(params){
		this.photoUrlParams = params;
	},
