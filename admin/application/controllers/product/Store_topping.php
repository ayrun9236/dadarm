 ...
 */
class Store_topping extends MY_Controller
{
	...
	public function data(){
		...
		$data = $this->service_product->store_topping_lists($res);
	...
	public function modify()
	{
		$para_validation = array(
			array('field' => 'product_nos[]', 'rules' => 'required', 'label' => '토핑번호'),
		...
		$is_update = $this->service_product->store_topping_modify($res);
