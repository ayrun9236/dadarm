        ...
        new Vue({
            ...
            methods: {
                readDataFromAPI(mode) {
                    ...
                    axios
                        .get("/user_board/history/data?per_page=" +itemsPerPage +"&page=" +page+'&'+searchs)
                        .then((res) => {
                            this.loading = false;
