...
<!--                                                        </v-col>-->
                                                    ...
                                                    <v-row>
                                                        <v-col cols="12"
                                                               ...
                                                               md="4">
                                                            <v-select
                                                                    v-model="editedItem.is_publish_store_all"
                                                                    :items="viewType"
                                                                    item-text="name"
                                                                    item-value="no"
                                                                    v-on:change="changeGrant('publish')"
                                                                    label="전체매장발행"
                                                                    persistent-hint
                                                            >
                                                            </v-select>
                                                        ...
                                                        <v-col cols="12"
                                                               ...
                                                               :key="store.no">
                                                            <v-checkbox
                                                                    v-model="editedItem.publish_store"
                                                                    color="error"
                                                                    :label="store.name"
                                                                    :value="store.no"
                                                                    :disabled="checkbox_publish_disabled"
                                                                    hide-details
                                                            ></v-checkbox>
                                                        </v-col>
                                                    </v-row>
        ...
        new Vue({
            ...
            data () {
                return {
                    ...
                    headers: [
                        ...
                        { text: '사용타입', value: 'coupon_order_type' },
                    ...
                    checkbox_publish_disabled : false,
                    schFields: {
                        product_name: "",
                        product_type: "",
                    },
            ...
            methods: {
                ...
                editItem (item) {
                    ...
                    this.checkbox_publish_disabled = false;

                    if(this.editedItem.is_use_store_all === true){
                        this.checkbox_disabled = true;
                    }

                    if(this.editedItem.is_publish_store_all === true){
                        this.checkbox_publish_disabled = true;
                    }
                    this.dialog = true;
                },
