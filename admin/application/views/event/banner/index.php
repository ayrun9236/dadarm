                                            ...
                                            <v-card-text>
                                                ...
                                                <v-container>
                                                    <v-row>
                                                        ...
                                                        <v-text-field v-model="editedItem.title" :rules="rules.required" label="제목" required style="margin-top: 10px"></v-text-field>
                                                        <v-text-field v-model="editedItem.etc" :rules="rules.required" label="서브 제목" required style="margin-top: 10px"></v-text-field>
                                                        </v-col>
                                                        ...
                                                        <v-col cols="12" sm="6" md="4">
                                                            <v-text-field v-model="editedItem.link"  label="링크" style="margin-top: 10px"></v-text-field>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
        ...
        new Vue({
            ...
            methods: {
                ...
                save () {
                    ...
                    formData.append('attach_image[]', this.editedItem.main_image);
